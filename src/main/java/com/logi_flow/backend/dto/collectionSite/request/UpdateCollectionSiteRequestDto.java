package com.logi_flow.backend.dto.collectionSite.request;
...
@AllArgsConstructor
@Getter
public class UpdateCollectionSiteRequestDto {
    @NotBlank(message = "수거지명은 필수 항목입니다.")
    @Pattern(regexp = Regex.BUSINESS, message = "수거지명은 한글, 영문, 숫자, 공백, 특수문자(·, &, /, -, ,, 괄호)만 사용가능합니다.")
    private String name;

    @NotBlank(message = "수거지 우편 번호는 필수 항목입니다.")
